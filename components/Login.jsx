...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Check if the sign-in object is loaded - It’s a boolean (true or false) that tells you whether the Clerk sign-in object is ready to use.
        if (!isLoaded) return;
                    ...
                    <div className="backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border transition-all duration-300 bg-white/10">
                            ...
                            <form onSubmit={(e) => handleSubmit(e)} className="space-y-3">
                                <div className="space-y-3">
                                    <div className="group relative">
                                        ...
                                        <p className={`${errors.email ? 'opacity-100' : 'opacity-0'} text-destructive text-xs mt-1 animate-in fade-in-50 px-2 text-red-400`}>**{errors.email} !</p>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        <button
                                            ...
                                            className={cn(
                                                "w-4 h-4 mr-2 rounded border flex items-center justify-center transition-all duration-200 cursor-pointer",
                                                rememberMe ? "bg-blue-400 border-blue-400" : "border-input"
                                            )}
                                            aria-checked={rememberMe}
                                            role="checkbox"
                                        >
                                            {rememberMe && (
                                                <svg width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg" className="animate-in fade-in-50">
                                                    <path d="M9 1L3.5 6.5L1 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-blue-400-foreground" />
                                                </svg>
                                            )}
                                        </button>
                                ...
                                <button
                                    ...
                                    disabled={isLoading}
                                    className={cn(
                                        "w-11/12 h-10 bg-bluetext-blue-400 rounded-md font-medium mx-auto bg-purple-600 my-7 cursor-pointer",
                        ...
                        <div className="p-6 border-t bg-gray-600/80 text-center">
                            <p className="text-sm">
                                ...
                                <Link href="/sign-up" className="text-blue-400 hover:text-blue-500 font-semibold transition-colors">
                                    Sign up
                                </Link>
                            </p>
                        </div>
