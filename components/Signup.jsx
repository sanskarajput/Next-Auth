                  ...
                  <div className="group relative">
                    <label
                      ...
                      className={cn(
                        ...
                        code ? "-top-[10px] bg-card px-1 text-[13px] bg-background text-purple-400" : "top-4.5 px-2.5 text-gray-300"
                      )}
                    >
                      Verification code
                    </label>
                ...
                <div className="space-y-3">
                  <div className="group relative">
                    <label
                      ...
                      className={cn(
                        "absolute left-3 text-sm transition-all duration-200 pointer-events-none z-1",
                        emailAddress ? "-top-[10px] bg-card px-1 text-[13px] bg-background text-purple-400" : "top-4.5 px-2.5 text-gray-300"
                      )}
                    >
                      Email address
                    </label>
